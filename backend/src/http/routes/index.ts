...
import { uploadSingle } from '@http/middlewares/uploadMiddleware';
...
router.post('/usuarios/importar-excel', uploadSingle('file'), (req, res, next) => usuarioController.importarExcel(req, res, next));
